			...
			for (i = 0; i < length; i++) {
				...
				for (var k = 0; k < keyLength; k++) {
					if (userListKeyArr[k] !== "videoLink") {
						...
						tableEditor.insertLinkRow(newRow, k,
								result[i][userListKeyArr[k]]);
					}
				}
			}
...
var htConstants = {
	aUserListAllInfo : [ "userID", "userStatus", "userVerification",
			"VerificationStatus", "verificationTime", "location",
			"locationCoordinate", "locationTime", "videoLink", "videoDate",
			"watch", "notify" ]
}
